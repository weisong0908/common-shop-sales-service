...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommonShop.SalesService.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = new Guid("6865a7fa-6866-4516-9002-53cc8386991e"),
                            Date = new DateTime(2021, 1, 30, 0, 0, 0, 0, DateTimeKind.Local),
                            OrderStatus = 0,
                            TotalPrice = 22m
                        },
                        new
                        {
                            ...
                            CustomerId = new Guid("f5f1e765-a3bb-44bb-89b9-52ab8eab9db4"),
                            Date = new DateTime(2021, 1, 29, 0, 0, 0, 0, DateTimeKind.Local),
                            OrderStatus = 0,
                            TotalPrice = 42m
                        },
                        new
                        {
                            ...
                            CustomerId = new Guid("3a538afc-1441-4c96-bf86-81a18ad0ca04"),
                            Date = new DateTime(2021, 1, 28, 0, 0, 0, 0, DateTimeKind.Local),
                            OrderStatus = 0,
                            TotalPrice = 62m
                        },
                        new
            ...
            modelBuilder.Entity("CommonShop.SalesService.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 10m,
                            ProductCategoryId = new Guid("6280198e-df28-4fa7-a095-3671f51501c7"),
                            StockLevel = 1,
                        ...
                        new
                        {
                            ...
                            Description = "Some description",
                            Price = 20m,
                            ProductCategoryId = new Guid("b1d36dfd-4c8a-48d1-8f61-af926ddfdf41"),
                            StockLevel = 2,
                            ThumbnailUrl = "https://bulma.io/images/placeholders/640x480.png",
                            Title = "Product 2"
                        },
            ...
            modelBuilder.Entity("CommonShop.SalesService.Models.ProductCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6280198e-df28-4fa7-a095-3671f51501c7"),
                            Title = "Category 1"
                        },
                        new
                        {
                            Id = new Guid("b1d36dfd-4c8a-48d1-8f61-af926ddfdf41"),
                            Title = "Category 2"
                        },
                        new
                        {
                            Id = new Guid("10fc51a4-1f9d-4296-ae45-4b797d466fae"),
                            Title = "Category 3"
                        });
                });
            ...
            modelBuilder.Entity("CommonShop.SalesService.Models.Product", b =>
                {
                    b.HasOne("CommonShop.SalesService.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
